...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        $sql = "SELECT admin_id, `name`, `password`, `role`, `email` FROM admins WHERE `name` = ?";
    ...
    <div class="wrapper-page float-left ml-5">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-3">
                    <h4 class="font-18 m-b-5 text-center">Administrator Login</h4>
                    <p class="text-muted text-center">Manage CricBet40 with your login ID</p>
